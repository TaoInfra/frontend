		...
		<div className='min-h-screen'>
			...
			<main className="flex flex-col items-center p-24">
				...
				<object data="https://general-s3-public.s3.us-east-2.amazonaws.com/terms-of-service.pdf" type="application/pdf" width="100%" height="800px">
					<p>Your browser does not support PDFs. Please download the PDF to view it: <a href="https://general-s3-public.s3.us-east-2.amazonaws.com/terms-of-service.pdf">Download PDF</a>.</p>
				</object>
			</main>
			<Footer />
		</div>
